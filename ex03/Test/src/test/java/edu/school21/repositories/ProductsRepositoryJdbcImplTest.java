...
public class ProductsRepositoryJdbcImplTest {
    ...
    void disconnectFindAll() {
        ...
        assertThrows(IllegalArgumentException.class, () -> productsRepository.findAll());
    }
    ...
    void disconnectFindById() {
        embeddedDataSource.db.shutdown();
        assertThrows(IllegalArgumentException.class, () -> productsRepository.findById(1L));
    }

    @Test
    void isNotFoundIdFindById() {
        embeddedDataSource.db.shutdown();
        assertThrows(IllegalArgumentException.class, () -> productsRepository.findById(111L));
    }
    ...
    void disconnectDelete() {
        embeddedDataSource.db.shutdown();
        assertThrows(IllegalArgumentException.class, () -> productsRepository.delete(1L));
    }
